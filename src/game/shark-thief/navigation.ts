...
function buildDepthSelectButtons(): void {
  ...
  const depths: Array<{ depth: number; cls: string; label: string }> = [
    ...
    { depth: 2, cls: "ds-d2",  label: "DEPTH 2 — THE REEF"     },
    { depth: 3, cls: "ds-d3",  label: "DEPTH 3 — THE NURSERY"  },
    { depth: 4, cls: "ds-d4",  label: "DEPTH 4 — THE ARCTIC"   },
    { depth: 5, cls: "ds-d5",  label: "DEPTH 5 — TOXIC"        },
    { depth: 6, cls: "ds-d6",  label: "DEPTH 6 — THE ABYSS"    },
  ];

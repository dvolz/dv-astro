import { b as createAstro, c as createComponent, m as maybeRenderHead, r as renderComponent, a as renderTemplate, d as addAttribute } from './astro/server_BDmygan7.mjs';
import 'piccolore';
		...
		posts.map(async (post) => {
			if (post.display) {
				try {
					...
					const DynamicComponent = await __variableDynamicImportRuntimeHelper((/* #__PURE__ */ Object.assign({"../components/display/shapes-and-grids-display.astro": () => import('./shapes-and-grids-display_xcMpYsKP.mjs'),"../components/display/style-guide-display.astro": () => import('./style-guide-display_BfS9JnLO.mjs'),"../components/display/test-thoughts-astro-post-display.astro": () => import('./test-thoughts-astro-post-display_D_KjERsT.mjs'),"../components/display/youtube-timing-controller-display.astro": () => import('./youtube-timing-controller-display_DgVAJCbY.mjs')})), `../components/display/${formattedTitle}-display.astro`, 4);

import { b as createAstro, c as createComponent, m as maybeRenderHead, r as renderComponent, F as Fragment, a as renderTemplate, u as unescapeHTML } from './astro/server_BDmygan7.mjs';
import 'piccolore';
...
const $$CodeBlock = createComponent(async ($$result, $$props, $$slots) => {
  ...
  highlighter.dispose();
  return renderTemplate`${maybeRenderHead()}<div class="code-block" data-astro-cid-jgrc2lfe> ${renderComponent($$result, "Fragment", Fragment, {}, { "default": async ($$result2) => renderTemplate`${unescapeHTML(html)}` })} </div> `;

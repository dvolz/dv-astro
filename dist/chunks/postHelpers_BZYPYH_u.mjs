import { b as createAstro, c as createComponent, r as renderTemplate, m as maybeRenderHead, a as renderComponent, d as addAttribute } from './astro/server_DHeFfUaE.mjs';
import 'piccolore';
		...
		posts.map(async (post) => {
			if (post.display) {
				try {
					...
					const DynamicComponent = await __variableDynamicImportRuntimeHelper((/* #__PURE__ */ Object.assign({"../components/display/shapes-and-grids-display.astro": () => import('./shapes-and-grids-display_XUFzYuHB.mjs'),"../components/display/test-thoughts-astro-post-display.astro": () => import('./test-thoughts-astro-post-display_Bq0jNn8K.mjs'),"../components/display/youtube-timing-controller-display.astro": () => import('./youtube-timing-controller-display_Cys0Ohmc.mjs')})), `../components/display/${formattedTitle}-display.astro`, 4);

import { b as createAstro, c as createComponent, r as renderComponent, a as renderTemplate, m as maybeRenderHead } from '../../chunks/astro/server_BDmygan7.mjs';
import 'piccolore';
import { $ as $$BaseLayout } from '../../chunks/BaseLayout_DaOo42CO.mjs';
import { t as transformPosts, l as loadDynamicComponents, $ as $$BlogPost } from '../../chunks/postHelpers_CtkuUk5K.mjs';
/* empty css                                    */
...
async function getStaticPaths() {
  const mdPlay = await Astro.glob(/* #__PURE__ */ Object.assign({}), () => "../play/*.md");
  const astroPlay = await Astro.glob(/* #__PURE__ */ Object.assign({"../play/shapes-and-grids.astro": () => import('../../chunks/shapes-and-grids_EgIp3LpU.mjs').then(n => n._),"../play/style-guide.astro": () => import('../../chunks/style-guide_D-TMbXOD.mjs').then(n => n._),"../play/svgs-and-astro.astro": () => import('../../chunks/svgs-and-astro_Cl94cajF.mjs').then(n => n._),"../play/youtube-timer.astro": () => import('../../chunks/youtube-timer_8OZkM7WR.mjs').then(n => n._)}), () => "../play/*.astro");
  ...
  const astroThoughts = await Astro.glob(/* #__PURE__ */ Object.assign({"../thoughts/astro-scripts.astro": () => import('../../chunks/astro-scripts_BGXX8Abg.mjs').then(n => n._)}), () => "../thoughts/*.astro");
  const allPosts = [
...
const $$tag = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$tag;
  const mdPlay = await Astro2.glob(/* #__PURE__ */ Object.assign({}), () => "../play/*.md");
  const astroPlay = await Astro2.glob(/* #__PURE__ */ Object.assign({"../play/shapes-and-grids.astro": () => import('../../chunks/shapes-and-grids_EgIp3LpU.mjs').then(n => n._),"../play/style-guide.astro": () => import('../../chunks/style-guide_D-TMbXOD.mjs').then(n => n._),"../play/svgs-and-astro.astro": () => import('../../chunks/svgs-and-astro_Cl94cajF.mjs').then(n => n._),"../play/youtube-timer.astro": () => import('../../chunks/youtube-timer_8OZkM7WR.mjs').then(n => n._)}), () => "../play/*.astro");
  const mdThoughts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../thoughts/post-1.md": () => import('../../chunks/post-1_CDz_IoTp.mjs').then(n => n._),"../thoughts/post-2.md": () => import('../../chunks/post-2_CfjFquE_.mjs').then(n => n._),"../thoughts/post-3.md": () => import('../../chunks/post-3_BqXloG5J.mjs').then(n => n._),"../thoughts/post-4.md": () => import('../../chunks/post-4_nQMqbTDr.mjs').then(n => n._)}), () => "../thoughts/*.md");
  const astroThoughts = await Astro2.glob(/* #__PURE__ */ Object.assign({"../thoughts/astro-scripts.astro": () => import('../../chunks/astro-scripts_BGXX8Abg.mjs').then(n => n._)}), () => "../thoughts/*.astro");
  const allPosts = [
    ...transformPosts(mdThoughts, "markdown"),
    ...transformPosts(astroThoughts, "astro"),
    ...transformPosts(mdPlay, "markdown"),

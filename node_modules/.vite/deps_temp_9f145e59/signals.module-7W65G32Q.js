...
function p2(n2) {
  ...
  var e2 = T(function() {
    ...
    r2.__$u.c = function() {
      var n4;
      if (!t(e2.peek()) && 3 === (null == (n4 = r2.base) ? void 0 : n4.nodeType)) r2.base.data = e2.peek();
      else {
        r2.__$f |= 1;
        r2.setState({});
      }
...
l3("__r", function(n2, r2) {
  ...
  if (t3) {
    t3.__$f &= -2;
    if (void 0 === (i2 = t3.__$u)) t3.__$u = i2 = function(n3) {
      var r3;
      E(function() {
        r3 = this;
      });
...
//# sourceMappingURL=signals.module-7W65G32Q.js.map
